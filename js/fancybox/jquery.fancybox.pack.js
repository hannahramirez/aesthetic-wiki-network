...
(function (s, l, d, t) {
  var m = d(s),
    ...
    n = function (b, c) {
      c &&
        o(b) &&
        0 < b.indexOf("%") &&
        (b = (a.getViewport()[c] / 100) * parseInt(b, 10));
  ...
  d.extend(a, {
    ...
    open: function (b, c) {
      ...
      d.isPlainObject(c) &&
        c.keys !== t &&
        (a.opts.keys = c.keys ? d.extend({}, a.defaults.keys, c.keys) : !1);
      a.group = b;
    ...
    close: function (b) {
      ...
      a.current &&
        ...
        (a.unbindEvents(),
        !a.isOpen || (b && !0 === b[0])
          ? (d(".fancybox-wrap").stop().trigger("onReset").remove(),
            a._afterZoomOut())
    ...
    jumpto: function (b) {
      a.current &&
        ...
        1 < a.group.length &&
          a.current.loop &&
          (b >= a.group.length ? (b = 0) : 0 > b && (b = a.group.length - 1)),
        a.group[b] !== t && (a.cancel(), a._start(b)));
    },
          ...
          setTimeout(function () {
            ...
            if (u && ((u = !1), c)) {
              if (!b || "scroll" !== b.type || e)
                c.autoSize &&
                  "iframe" !== c.type &&
                  (a.inner.height("auto"), (c.height = a.inner.height())),
    ...
    showLoading: function () {
      ...
      d('<div id="fancybox-loading"><div></div></div>')
        .click(a.cancel)
        .appendTo("body");
    },
      ...
      b &&
        (m.bind(
          "resize.fb orientationchange.fb" +
            (b.autoCenter && !b.fixed ? " scroll.fb" : ""),
          a.update
        ),
        c &&
          q.bind("keydown.fb", function (b) {
            ...
            if (
              ...
              !b.shiftKey &&
              !b.metaKey &&
              (!f || (!f.type && !d(f).is("[contenteditable]")))
            )
              (f = b.keyCode),
                -1 < d.inArray(f, c.close)
    ...
    trigger: function (b, c) {
      var e,
        f =
          c ||
          a[
            -1 < d.inArray(b, ["onCancel", "beforeLoad", "afterLoad"])
              ? "coming"
              : "current"
          ];
      if (f) {
        d.isFunction(f[b]) &&
          (e = f[b].apply(f, Array.prototype.slice.call(arguments, 1)));
        if (!1 === e) return !1;
        f.helpers &&
          d.each(f.helpers, function (c, e) {
            if (
              e &&
              d.isPlainObject(a.helpers[c]) &&
              d.isFunction(a.helpers[c][b])
            )
              a.helpers[c][b](e, f);
          });
    ...
    _start: function (b) {
      ...
      if (!1 === a.trigger("beforeLoad")) a.coming = null;
        ...
        g ||
          (f &&
            ((g = d(e).data("fancybox-type")),
            g ||
              (g = (g = e.className.match(/fancybox\.(\w+)/)) ? g[1] : null)),
          !g &&
            o(b) &&
            (a.isImage(b)
              ? (g = "image")
        ...
        "ajax" === g &&
          o(b) &&
          ((i = b.split(/\s+/, 2)), (b = i.shift()), (c.selector = i.shift()));
        c.href = b;
        c.group = a.group;
        c.isDom = f;
        switch (g) {
      ...
      !a.coming || !1 === a.trigger("afterLoad", a.current)
        ...
        : (a.isOpened
            ? (d(".fancybox-item, .fancybox-nav").remove(),
              a.wrap.stop(!0).removeClass("fancybox-opened"),
              a.inner.css("overflow", "hidden"),
              a.transitions[a.current.prevMethod]())
            : (d(".fancybox-wrap").stop().trigger("onReset").remove(),
              a.trigger("afterClose")),
          a.unbindEvents(),
          (a.isOpen = !1),
          (a.current = a.coming),
          (a.wrap = d(a.current.tpl.wrap)
            .addClass(
              "fancybox-" +
                (k ? "mobile" : "desktop") +
                " fancybox-type-" +
            ...
            .appendTo("body")),
          (a.skin = d(".fancybox-skin", a.wrap).css(
            "padding",
            n(a.current.padding)
          )),
      ...
      switch (e) {
        ...
        case "html":
          b.selector
            ...
            : c instanceof d &&
              (c.parent().hasClass("fancybox-inner") &&
                c.parents(".fancybox-wrap").unbind("onReset"),
              (c = c.show().detach()),
        ...
        case "swf":
          c = b.tpl.swf
            .replace(/\{width\}/g, b.width)
            .replace(/\{height\}/g, b.height)
            .replace(/\{href\}/g, b.href);
          break;
        case "iframe":
          (c = d(b.tpl.iframe.replace("{rnd}", new Date().getTime()))
            .attr("scrolling", b.scrolling)
            .attr("src", b.href)),
    ...
    _getPosition: function (b) {
      var c = a.current,
        ...
        h = { position: "absolute", top: f[0] + e.y, left: f[3] + e.x };
      c.autoCenter &&
        c.fixed &&
        !b &&
        i <= e.h &&
        d <= e.w &&
        (h = { position: "fixed", top: f[0], left: f[3] });
    ...
    _afterZoomIn: function () {
      ...
      if (
        ...
        (b.closeClick || b.nextClick) &&
          a.inner.css("cursor", "pointer").bind("click.fb", function (c) {
            if (!d(c.target).is("a") && !d(c.target).parent().is("a"))
              a[b.closeClick ? "close" : "next"]();
          }),
        b.closeBtn &&
          d(b.tpl.closeBtn).appendTo(a.skin).bind("click.fb", a.close),
        b.arrows &&
          1 < a.group.length &&
          ((b.loop || 0 < b.index) &&
            d(b.tpl.prev).appendTo(a.outer).bind("click.fb", a.prev),
          (b.loop || b.index < a.group.length - 1) &&
            d(b.tpl.next).appendTo(a.outer).bind("click.fb", a.next)),
  ...
  a.transitions = {
    getOrigPosition: function () {
      ...
      !f.length &&
        b.isDom &&
        d(c).is(":visible") &&
        ((f = d(c).find("img:first")), f.length || (f = d(c)));
      f.length
        ? ((g = f.offset()),
          f.is("img") && ((i = f.outerWidth()), (h = f.outerHeight())))
        : ((b = a.getViewport()),
          (g.top = b.y + 0.5 * (b.h - h)),
  ...
  a.helpers.overlay = {
    ...
    update: function () {
      ...
      d.browser.msie || k
        ? ((a = Math.max(l.documentElement.scrollWidth, l.body.scrollWidth)),
    ...
    beforeShow: function (b) {
      this.overlay ||
        ((b = d.extend(!0, {}, a.defaults.helpers.overlay, b)),
        (this.overlay = d('<div id="fancybox-overlay"></div>')
          .css(b.css)
          .appendTo("body")),
    ...
    beforeShow: function (b) {
      ...
      if ((c = a.current.title))
        (c = d(
          ...
          c.appendTo(
            "over" === b.type ? a.inner : "outside" === b.type ? a.wrap : a.skin
          );
    },
  };
  ...
  d(l).ready(function () {
    a.defaults.fixed =
      d.support.fixedPosition ||
      (!(d.browser.msie && 6 >= d.browser.version) && !k);
  });
